...
- En una corrida posterior salió 9,6: el juez no siempre audita los mismos requerimientos y esa vez le tocó RF08, que marcó parcial porque el diagrama no mostraba quién arma el resumen del escalamiento ni a quién se lo asigna. Lo agregamos: **Incidentes Service** arma el resumen con lo que ya se preguntó y se ejecutó y se lo asigna al SRE on-call, y el aviso le llega por Slack.
